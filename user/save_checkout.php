...
session_start();
 ...
 $news="INSERT INTO orders(OrderDate,name,address,email,phone,price,ID)
 values('".date("y-m-d h:i:s")."','".$_POST["name"]."','".$_POST["address"]."','".$_POST["email"]."','".$_POST["phone"]."','".$_POST["price"]."','".$_POST["ID"]."')";
