...
<table width="1024" border="0"  valing="top"align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <input type="text" name="name" class="form-control"value="<?php echo $newr5["name"];?>"  placeholder="ชื่อผู้สั่งซื้อ"id="" required>
    </div>
    <div class="form-group col-7">
    <label for="">ที่อยู่</label>
   <textarea name="address" id=""class="form-control" cols="30" rows="10"id="" required><?php echo $newr5["address"];?></textarea>
    </div>
    <div class="form-group col-7">
    ...
    <input type="text" name="phone" class="form-control"value="<?php echo $newr5["phone"];?> "placeholder="เบอร์โทร"id=""maxlength="10" required>
    </div>
    <input type="hidden" name="ID" class="form-control"value="<?php echo $newr5["ID"];?>">
    <input type="hidden" name="price" class="form-control"value="<?php echo number_format($sum);?>">
